...
|---|---|
| Versiya | **1.1.71** |
| Fayl | `utm-update-1.1.71.utmupd` |
| Chiqarilgan | 2026-09-22 |
| SHA256 | `8ca783288e922c89d2887e4c15624773b2fb9ceb3ecd2cb5c038f276d93b7a70` |
...
```bash
curl -fLO https://raw.githubusercontent.com/soatov86/linux-utm-gateway-releases/main/utm-update-1.1.71.utmupd
```

`latest.json` dagi digest bilan solishtiring:

```bash
sha256sum utm-update-1.1.71.utmupd
```

Qurilmaga ko'chiring va o'rnatishga qo'ying:

```bash
sudo mkdir -p /var/lib/utm/updates && sudo install -m600 -o root -g root utm-update-1.1.71.utmupd /var/lib/utm/updates/pending.utmupd
```
