...
|---|---|
| Versiya | **1.1.72** |
| Fayl | `utm-update-1.1.72.utmupd` |
| Chiqarilgan | 2026-09-23 |
| SHA256 | `ecbfa3f2d4c635eefbf2583447d317441563285e56bca3f90f66f6453f8c504e` |
...
```bash
curl -fLO https://raw.githubusercontent.com/soatov86/linux-utm-gateway-releases/main/utm-update-1.1.72.utmupd
```

`latest.json` dagi digest bilan solishtiring:

```bash
sha256sum utm-update-1.1.72.utmupd
```

Qurilmaga ko'chiring va o'rnatishga qo'ying:

```bash
sudo mkdir -p /var/lib/utm/updates && sudo install -m600 -o root -g root utm-update-1.1.72.utmupd /var/lib/utm/updates/pending.utmupd
```
