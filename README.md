...
|---|---|
| Versiya | **1.1.79** |
| Fayl | `utm-update-1.1.79.utmupd` |
| Chiqarilgan | 2026-09-24 |
| SHA256 | `bb6523a21af64e4518d92c821ec73d80e057b5a7b8a5dfd9ec99d6852212c98f` |
...
```bash
curl -fLO https://raw.githubusercontent.com/soatov86/linux-utm-gateway-releases/main/utm-update-1.1.79.utmupd
```

`latest.json` dagi digest bilan solishtiring:

```bash
sha256sum utm-update-1.1.79.utmupd
```

Qurilmaga ko'chiring va o'rnatishga qo'ying:

```bash
sudo mkdir -p /var/lib/utm/updates && sudo install -m600 -o root -g root utm-update-1.1.79.utmupd /var/lib/utm/updates/pending.utmupd
```
