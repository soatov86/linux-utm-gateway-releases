...
|---|---|
| Versiya | **1.1.80** |
| Fayl | `utm-update-1.1.80.utmupd` |
| Chiqarilgan | 2026-09-24 |
| SHA256 | `7c88d1dd41e0e640c03694a5eb055ff6d8de016a443a27c0f1e0e0dd430e45b8` |
...
```bash
curl -fLO https://raw.githubusercontent.com/soatov86/linux-utm-gateway-releases/main/utm-update-1.1.80.utmupd
```

`latest.json` dagi digest bilan solishtiring:

```bash
sha256sum utm-update-1.1.80.utmupd
```

Qurilmaga ko'chiring va o'rnatishga qo'ying:

```bash
sudo mkdir -p /var/lib/utm/updates && sudo install -m600 -o root -g root utm-update-1.1.80.utmupd /var/lib/utm/updates/pending.utmupd
```
