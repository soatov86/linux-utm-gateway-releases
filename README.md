...
|---|---|
| Versiya | **1.1.69** |
| Fayl | `utm-update-1.1.69.utmupd` |
| Chiqarilgan | 2026-09-17 |
| SHA256 | `0543d4f11fc86d7f9ac0019dc56b1c9696489a9d8c57c4cb6ed1ae6e7f2ee17b` |
...
```bash
curl -fLO https://raw.githubusercontent.com/soatov86/linux-utm-gateway-releases/main/utm-update-1.1.69.utmupd
```

`latest.json` dagi digest bilan solishtiring:

```bash
sha256sum utm-update-1.1.69.utmupd
```

Qurilmaga ko'chiring va o'rnatishga qo'ying:

```bash
sudo mkdir -p /var/lib/utm/updates && sudo install -m600 -o root -g root utm-update-1.1.69.utmupd /var/lib/utm/updates/pending.utmupd
```
