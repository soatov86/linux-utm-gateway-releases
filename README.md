...
|---|---|
| Versiya | **1.1.73** |
| Fayl | `utm-update-1.1.73.utmupd` |
| Chiqarilgan | 2026-09-23 |
| SHA256 | `ede6ce0aca953cdd19d02988ed634b26f971b339d2f01f5b38790fee1b4380da` |
...
```bash
curl -fLO https://raw.githubusercontent.com/soatov86/linux-utm-gateway-releases/main/utm-update-1.1.73.utmupd
```

`latest.json` dagi digest bilan solishtiring:

```bash
sha256sum utm-update-1.1.73.utmupd
```

Qurilmaga ko'chiring va o'rnatishga qo'ying:

```bash
sudo mkdir -p /var/lib/utm/updates && sudo install -m600 -o root -g root utm-update-1.1.73.utmupd /var/lib/utm/updates/pending.utmupd
```
