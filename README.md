...
|---|---|
| Versiya | **1.1.63** |
| Fayl | `utm-update-1.1.63.utmupd` |
| Chiqarilgan | 2026-09-15 |
| SHA256 | `8244620328749a576fa9477e99ddbbc3ea08bf32dfc20942bf768009ad8f822c` |
...
```bash
curl -fLO https://raw.githubusercontent.com/soatov86/linux-utm-gateway-releases/main/utm-update-1.1.63.utmupd
```

`latest.json` dagi digest bilan solishtiring:

```bash
sha256sum utm-update-1.1.63.utmupd
```

Qurilmaga ko'chiring va o'rnatishga qo'ying:

```bash
sudo mkdir -p /var/lib/utm/updates && sudo install -m600 -o root -g root utm-update-1.1.63.utmupd /var/lib/utm/updates/pending.utmupd
```
