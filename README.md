...
|---|---|
| Versiya | **1.1.68** |
| Fayl | `utm-update-1.1.68.utmupd` |
| Chiqarilgan | 2026-09-17 |
| SHA256 | `f4ebc75e124994b8a9d912e703034ed41746c1e3f1119e5515f38d30272dcf6e` |
...
```bash
curl -fLO https://raw.githubusercontent.com/soatov86/linux-utm-gateway-releases/main/utm-update-1.1.68.utmupd
```

`latest.json` dagi digest bilan solishtiring:

```bash
sha256sum utm-update-1.1.68.utmupd
```

Qurilmaga ko'chiring va o'rnatishga qo'ying:

```bash
sudo mkdir -p /var/lib/utm/updates && sudo install -m600 -o root -g root utm-update-1.1.68.utmupd /var/lib/utm/updates/pending.utmupd
```
