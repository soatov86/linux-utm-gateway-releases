...
|---|---|
| Versiya | **1.1.81** |
| Fayl | `utm-update-1.1.81.utmupd` |
| Chiqarilgan | 2026-09-25 |
| SHA256 | `8d94dccc795fad76f85137b9ba9bfa112c532173dbdba4c7687b153374127117` |
...
```bash
curl -fLO https://raw.githubusercontent.com/soatov86/linux-utm-gateway-releases/main/utm-update-1.1.81.utmupd
```

`latest.json` dagi digest bilan solishtiring:

```bash
sha256sum utm-update-1.1.81.utmupd
```

Qurilmaga ko'chiring va o'rnatishga qo'ying:

```bash
sudo mkdir -p /var/lib/utm/updates && sudo install -m600 -o root -g root utm-update-1.1.81.utmupd /var/lib/utm/updates/pending.utmupd
```
