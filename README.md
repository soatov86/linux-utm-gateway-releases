...
|---|---|
| Versiya | **1.1.55** |
| Fayl | `utm-update-1.1.55.utmupd` |
| Chiqarilgan | 2026-09-10 |
| SHA256 | `8a215fe15e102e92e8b100ad4924be88f5edb2081a1d195945bfa8d43e922199` |
...
```bash
curl -fLO https://raw.githubusercontent.com/soatov86/linux-utm-gateway-releases/main/utm-update-1.1.55.utmupd
```

`latest.json` dagi digest bilan solishtiring:

```bash
sha256sum utm-update-1.1.55.utmupd
```

Qurilmaga ko'chiring va o'rnatishga qo'ying:

```bash
sudo mkdir -p /var/lib/utm/updates && sudo install -m600 -o root -g root utm-update-1.1.55.utmupd /var/lib/utm/updates/pending.utmupd
```
