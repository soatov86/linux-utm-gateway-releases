...
|---|---|
| Versiya | **1.1.70** |
| Fayl | `utm-update-1.1.70.utmupd` |
| Chiqarilgan | 2026-09-17 |
| SHA256 | `8061f3e94266dd57b1fc06b3232994dd85283dab0f7be6c8e193468d7aa9b7c1` |
...
```bash
curl -fLO https://raw.githubusercontent.com/soatov86/linux-utm-gateway-releases/main/utm-update-1.1.70.utmupd
```

`latest.json` dagi digest bilan solishtiring:

```bash
sha256sum utm-update-1.1.70.utmupd
```

Qurilmaga ko'chiring va o'rnatishga qo'ying:

```bash
sudo mkdir -p /var/lib/utm/updates && sudo install -m600 -o root -g root utm-update-1.1.70.utmupd /var/lib/utm/updates/pending.utmupd
```
