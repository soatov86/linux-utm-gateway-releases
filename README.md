...
|---|---|
| Versiya | **1.1.60** |
| Fayl | `utm-update-1.1.60.utmupd` |
| Chiqarilgan | 2026-09-14 |
| SHA256 | `c82f52e68a9c71c508ccdad9cd004e7ebb4f727abf2bae0fe409e8482db4da51` |
...
```bash
curl -fLO https://raw.githubusercontent.com/soatov86/linux-utm-gateway-releases/main/utm-update-1.1.60.utmupd
```

`latest.json` dagi digest bilan solishtiring:

```bash
sha256sum utm-update-1.1.60.utmupd
```

Qurilmaga ko'chiring va o'rnatishga qo'ying:

```bash
sudo mkdir -p /var/lib/utm/updates && sudo install -m600 -o root -g root utm-update-1.1.60.utmupd /var/lib/utm/updates/pending.utmupd
```
